    ...
    .clock {
      ...
      .circle {
        ...
        &:before {
          ...
          border-radius: 50%;
          box-shadow:
            0 0 20px ${(props) => props.secondColor},
            0 0 60px ${(props) => props.secondColor};
        }
      ...
      .circle-mn {
        ...
        &:before {
          ...
          box-shadow:
            0 0 20px ${(props) => props.minuteColor},
            0 0 60px ${(props) => props.minuteColor};
        }
      ...
      .circle-hr {
        ...
        &:before {
          ...
          box-shadow:
            0 0 20px ${(props) => props.hourColor},
            0 0 60px ${(props) => props.hourColor};
        }
